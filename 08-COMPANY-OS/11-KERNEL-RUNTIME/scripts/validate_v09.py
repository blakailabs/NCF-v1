...
EXPECTED_V08_BASELINE=415; EXPECTED_TARGETED_TESTS=505
TESTS=list(V08_TESTS)+["test_production_infrastructure_v09","test_spanner_backend_v091","test_spanner_live_certification_v091","test_spanner_pre_gcp_v091","test_spanner_sdk_boundary_v091","test_spanner_transaction_semantics_v091","test_spanner_client_adapter_v091"]
def main()->int:
 compile_ok=True
